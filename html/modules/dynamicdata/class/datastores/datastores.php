...
class Dynamic_DataStore_Master
{
    ...
    function &getDataStore($name = '_dynamic_data_', $type = 'data')
    {
        ...
        {
            case 'table':
                sys::import('xaraya.datastores.Dynamic_FlatTable_DataStore');
                $datastore = new Dynamic_FlatTable_DataStore($name);
                break;
            case 'data':
                sys::import('xaraya.datastores.Dynamic_VariableTable_DataStore');
                $datastore = new Dynamic_VariableTable_DataStore($name);
                break;
            case 'hook':
                sys::import('xaraya.datastores.Dynamic_Hook_DataStore');
                $datastore = new Dynamic_Hook_DataStore($name);
                break;
            case 'function':
                sys::import('xaraya.datastores.Dynamic_Function_DataStore');
                $datastore = new Dynamic_Function_DataStore($name);
                break;
            case 'uservars':
                sys::import('xaraya.datastores.Dynamic_UserSettings_DataStore');
            // TODO: integrate user variable handling with DD
                $datastore = new Dynamic_UserSettings_DataStore($name);
                break;
            case 'modulevars':
                sys::import('xaraya.datastores.Dynamic_ModuleVariables_DataStore');
       ...
       // TODO: other data stores
            case 'ldap':
                sys::import('xaraya.datastores.Dynamic_LDAP_DataStore');
                $datastore = new Dynamic_LDAP_DataStore($name);
                break;
            case 'xml':
                sys::import('xaraya.datastores.Dynamic_XMLFile_DataStore');
                $datastore = new Dynamic_XMLFile_DataStore($name);
                break;
            case 'csv':
                sys::import('xaraya.datastores.Dynamic_CSVFile_DataStore');
                $datastore = new Dynamic_CSVFile_DataStore($name);
                break;
            case 'dummy':
            default:
                sys::import('xaraya.datastores.Dynamic_Dummy_DataStore');
