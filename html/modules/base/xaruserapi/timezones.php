...
// alias of Sao_Paulo for bug 4156 - re-apply when this gets regenerated by the timezone module
    ...
    $Zones['Asia/Almaty'] = array('6:00', 'RussiaAsia', 'ALM%sT');
    $Zones['Asia/Amman'] = array('2:00', 'Jordan', 'EE%sT');
    $Zones['Asia/Anadyr'] = array('12:00', 'Russia', 'ANA%sT');
    $Zones['Asia/Aqtau'] = array('4:00', 'RussiaAsia', 'AQT%sT');
    $Zones['Asia/Aqtobe'] = array('5:00', 'RussiaAsia', 'AQT%sT');
    ...
    $Zones['Asia/Oral'] = array('4:00', 'RussiaAsia', 'ORA%sT');
    ...
    $Zones['Asia/Qyzylorda'] = array('6:00', 'RussiaAsia', 'QYZ%sT');
