...
Please refer to the current edition of the &ldquo;Xaraya Official Protocol
Standards&rdquo; (STD&nbsp;1) for the standardization state and status of this
protocol.
Distribution of this memo is unlimited."}

               {bcp      "Best Current Practice" BCP
"This document specifies an Xaraya Best Current Practices for the Xaraya
Community, and requests discussion and suggestions for improvements.
Distribution of this memo is unlimited."}
...
By submitting this Xaraya-Draft,
...
THE DIGITAL DEVELOPMENT FOUNDATION DISCLAIM
ALL WARRANTIES,
EXPRESS OR IMPLIED,
...
set copylong1 {
"Copyright &copy; The Digital Development Foundation (%YEAR%). All Rights Reserved."
...
&ldquo;AS IS&rdquo; basis and THE DIGITAL DEVELOPMENT FOUNDATION
...
set copylong2 {
"Copyright &copy; The Digital Development Foundation (%YEAR%).
...
set iprurl "http://ddfoundation.org"
set ipremail "legal@ddfoundation.org"
...
specification can be obtained from the DDF Secretariat."
...
"Copies of IPR disclosures made to the DDF Secretariat and any
assurances of licenses to be made available,
or the result of an attempt made to obtain a general license or
permission for the use of such proprietary rights by implementers or
users of this specification can be obtained from the DDF on-line IPR
repository at %IPRURL%."

"The DDF invites any interested party to bring to its attention
any copyrights,
patents or patent applications,
or other
proprietary rights that may cover technology that may be required
to implement this standard.
Please address the information to the DDF at %IPREMAIL%."
}
...
permissions granted to DDF herein, and (c) any required
...
THE DDF AND ITS MEMBERS FOR THE COST OF PROCURING SUBSTITUTE GOODS
...
"Xaraya-Drafts are working documents of the The Digital Development 
