 ...
 * Deprecation Row
 */
function xarEvt_trigger($eventName, $value = NULL) {return xarEvents::trigger($eventName);}
function xarEvt_registerEvent($eventName) {return xarEvents::register($eventName);}
